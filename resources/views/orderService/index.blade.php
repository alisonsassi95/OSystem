                                    ...
                                    <div class="modal-body">
                                        <form action=" {{ route('orderService.estimate') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Nº do Orçamento</label>
                                                <input type="text" readonly name="id_solicitacao" value="{{ $orderService->id }}"class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="value" class="form-control" for="inlineFormInputGroup" placeholder="valor do orçamento">
                                                ...
                                                <br>
                                                <label> Data estimada para respostas  </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="StatusAll">
                                                    @foreach ($status as $x)     
                                                        <option required selected  id ="StatusAll" value={{$x->id}}>{{$x->name}}</option>    
                                                    @endforeach                                                                                  
                                                </select>
                                            </div>
